...
function App() {
  ...
  return (
    ...
    >
      ...
      {value && (
        <div>
          <TimeAndLocation weatherResponse={value.weatherLocationRes} weatherOnecallResponse={value.oncallLocationRes} />
          <TempreatureAndDetails weatherResponse={value.weatherLocationRes} weatherOnecallResponse={value.oncallLocationRes} />
